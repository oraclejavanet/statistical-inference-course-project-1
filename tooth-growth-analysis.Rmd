...
of different doses of vitamin C using two delivery methods to study the tooth
growth in guinea pigs. 

### Conclusions

Based on exploratory data analysis and configured by hypothesis tests and the
