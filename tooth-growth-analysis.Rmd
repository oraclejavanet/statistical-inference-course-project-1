...
* Tooth growth follows a normal distibution.

* The two variables, dosage levels and delivery method, must be independent and
...
associated confidence intervals, we can safely conclude that an increase in
