...
`r t.test(simMeans$expMean, conf.level=0.95)$conf.int[2]` which match closely.
...
line in the plot above represents a normal distribution which is very close to
